...
namespace pubsProject.Models
{
    ...
    public partial class pubsEntities : DbContext
    {
        ...
        public virtual ObjectResult<sp_booksauthor_Result> sp_booksauthor()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_booksauthor_Result>("sp_booksauthor");
        }
    
        public virtual ObjectResult<sp_displaybooks_Result> sp_displaybooks()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_displaybooks_Result>("sp_displaybooks");
        }
    
        public virtual ObjectResult<sp_display_Result> sp_display()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_display_Result>("sp_display");
        }
    }
}
