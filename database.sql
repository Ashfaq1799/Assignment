...
create procedure sp_authorbooks as 
begin
select a.au_lname+a.au_fname as name,title from authors a join titleauthor on a.au_id=titleauthor.au_id join titles on titles.title_id=titleauthor.title_id
end

alter procedure sp_booksauthor as 
begin 
select title,a.au_lname+a.au_fname as name from titles join titleauthor on titles.title_id=titleauthor.title_id  left join authors a on a.au_id=titleauthor.au_id group by a.au_lname,a.au_fname,titles.title
end

alter procedure sp_proc as
begin
select a.au_lname+a.au_fname as name,title from authors a,titles t,titleauthor ta where a.au_id=ta.au_id and t.title_id=ta.title_id
end
